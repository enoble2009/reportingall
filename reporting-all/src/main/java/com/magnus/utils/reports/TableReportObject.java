...
public class TableReportObject {
	...
	public static String processTable(Connection reportConn, String name, List<FileBodyObjectColumn> columns, List<FileBodyObjectValue> values, List<String> tableHeader, List<FileBodyObjectDataType> tableTypes, List<Map<String, String>> table) throws SQLException, ScriptException {
		return String.format("%s", tableToHTML(columns, values, tableHeader, tableTypes, table));
	}
	...
	private static String tableToHTML(List<FileBodyObjectColumn> columns, List<FileBodyObjectValue> values, List<String> tableHeader, List<FileBodyObjectDataType> tableTypes, List<Map<String, String>> table) throws ScriptException {
		...
		return String.format("<table class=\"table table-striped\"><thead>%s</thead><tbody>%s</tbody></table>", head, body);
	}
